<!DOCTYPE html>
<html>
<title>Avaiable Blood Sample</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-bar-block w3-card-2 w3-animate-left w3-center" style="display:none" id="mySidebar">
 ...
 <a href="RequestSample.html" class="w3-bar-item w3-button">Request Blood Samples</a>
...
<button class="w3-btn w3-xlarge w3-theme-dark w3-hover-red" onclick="document.write('<?php checkLogin() ?>').style.display='block'" style="font-weight:900;">Request Blood Sample</button>
...
function checkLogin()
{
	...
	{
	header("location: RequestSample.php");		
	}
	else
	{
